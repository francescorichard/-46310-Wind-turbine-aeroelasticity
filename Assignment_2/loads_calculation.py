...
class LoadsCalculation():
    def __init__(self,aoa, lift_coefficient,drag_coefficient,separation_function,
                             ...
                             number_of_airfoils,thickness_to_chord,B=3,P_rtd=10*1e6,V_in=4,V_out=25,RHO=1.225,
                 theta_cone=0,theta_yaw=0,theta_pitch=0,H=119,L_s=7.1,
    ...
    def relative_velocity(self,vel_sys4,induced_wind,radial_position,omega):
        ...
        '''
        V_rel_y = vel_sys4[1]+induced_wind[1]-omega*radial_position\
