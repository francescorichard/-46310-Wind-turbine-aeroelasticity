...
class PositionDefinition():
    def __init__(self,TRANSFORMATION_MATR,omega=0.72,H=119,L_s=7.1):
    ...
    def final_calculation_position(self,theta_blade,x_b):
         ...
         return self.TRANSFORMATION_MATR.r_point,self.TRANSFORMATION_MATR.a_1,\
                self.TRANSFORMATION_MATR.a_2,self.TRANSFORMATION_MATR.a_12,\
                self.TRANSFORMATION_MATR.a_23,self.TRANSFORMATION_MATR.a_34,\
                self.TRANSFORMATION_MATR.a_14,self.TRANSFORMATION_MATR.a_21,\
                self.TRANSFORMATION_MATR.a_41
